...
namespace ZephyrSharp
{
    namespace Graphics
    {
        ...
        public ref class GraphicsDeviceContext
            : public INativeSingletonWrapper<zephyr::graphics::d3d11::GraphicsDeviceContext>
        {
        public:
            ...
            {
                Native->SetPrimitiveTopology((zephyr::graphics::d3d11::PrimitiveTopology)topology);
            }
