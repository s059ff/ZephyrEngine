...
namespace ZephyrSharp
{
    namespace Graphics
    {
        ...
        generic <typename V> where V : value struct
            ...
            : public INativeWrapper<zephyr::graphics::d3d11::VertexBuffer>
        {
        public:
            ...
            {
                Native->Create(sizeof(V), count, (zephyr::graphics::d3d11::Accessibility)access);
            }
            ...
            void Create(array<V>^ source, Accessibility access)
            {
                ...
                Native->Create(ptr, stride, count, (zephyr::graphics::d3d11::Accessibility)access);
            }
            ...
            {
                int stride = sizeof(V);
                Native->Create(source, stride, count, (zephyr::graphics::d3d11::Accessibility)access);
            }
