    ...
    namespace Graphics
    {
        ...
        public:
            ...
            void Create(array<VertexElement^>^ elements, VertexShader^ shader)
            {
                ...
                auto _elements = new zephyr::graphics::dx11::VertexElement[count];
                auto semanticNames = new string[count];
                {
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        dest.Format = (zephyr::graphics::dx11::Format)src.Format;
                        dest.InputSlot = src.InputSlot;
                        dest.AlignedByteOffset = src.AlignedByteOffset;
                        dest.InputSlotClass = (zephyr::graphics::dx11::VertexElement::Classification)src.InputSlotClass;
