...
namespace zephyr
{
    namespace sound
    {
        ...
        public:
            ...
            /// </summary>
            READWRITE_PROPERTY(unsigned long, Frequency, ;, ;);

            /// <summary>
            /// 音量を 0 ～ 1 の範囲で取得または設定します。 0 のとき最小、 1 のとき最大を表します。
            /// </summary>
            READWRITE_PROPERTY(double, Volume, ; , ;);

            /// <summary>
            /// パンを -1 ～ +1 の範囲で取得または設定します。 -1 のとき左側のスピーカーからのみ音が鳴り、 +1 のとき右側のスピーカーからのみ音が鳴ります。
            /// </summary>
            READWRITE_PROPERTY(double, Pan, ;, ;);

            /// <summary>
            /// 原音のサンプリング周波数を取得します。
            /// </summary>
            READONLY_PROPERTY(unsigned long, OriginalFrequency, { return this->originalFrequency; });
